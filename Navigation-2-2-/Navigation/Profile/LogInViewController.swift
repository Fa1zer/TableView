...
class LogInViewController: UIViewController {
    ...
    private let usersPassword: UITextField = {
       let password = UITextField()
        ...
        password.layer.maskedCorners = [.layerMinXMaxYCorner,
                                        .layerMaxXMaxYCorner]
    ...
    private let logInButton: UIButton = {
        ...
        button.backgroundColor = UIColor(patternImage:
                                            UIImage(named: "blue_pixel")!)
    ...
    private func setupViews() {
        ...
        let constraints = [
            ...
            vkLogo.centerXAnchor.constraint(equalTo:
                                                containerView.centerXAnchor),
            vkLogo.topAnchor.constraint(equalTo:
            ...
            usersEmailOrPhone.trailingAnchor.constraint(equalTo:
                                               ...
                                               constant: -16),
            usersEmailOrPhone.topAnchor.constraint(equalTo:
                                        vkLogo.bottomAnchor, constant: 120),
            ...
            usersPassword.trailingAnchor.constraint(equalTo:
                                                containerView.trailingAnchor,
                                                        constant: -16),
            usersPassword.topAnchor.constraint(equalTo:
                                            usersEmailOrPhone.bottomAnchor,
                                               constant: -0.5),
            usersPassword.heightAnchor.constraint(equalTo:
                                            usersEmailOrPhone.heightAnchor),
            
            logInButton.topAnchor.constraint(equalTo:
                                                usersPassword.bottomAnchor,
                                             constant: 16),
